...
const ProductPage = ({ setItemsCart }: ProductType) => {
  ...
  async function loadOrders() {
    try {
      ...
      const response = await fetch('https://fsaooroft7.execute-api.ap-southeast-1.amazonaws.com/product/filter', r)
      ...
      const response2 = await fetch('https://fsaooroft7.execute-api.ap-southeast-1.amazonaws.com/category', r2)
