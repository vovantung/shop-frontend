...
const PropertyOrder = () => {
  ...
  async function handlePlaceOrder0() {
    try {
      ...
      const response = await fetch('hhttp://alb-app1-1640396686.ap-southeast-1.elb.amazonaws.com:8080/order', r)
  ...
  async function handleRemoveCart0(userId: string) {
    ...
    try {
      ...
      await fetch('http://alb-app1-1640396686.ap-southeast-1.elb.amazonaws.com:8080/cartitem/' + userId, r)
    } catch (error) {
      Router.replace('/pages/misc/500-server-error')
    }
  }
