...
const Orders = () => {
  ...
  async function getViewItemsOrder(orderId: string) {
    try {
      ...
      const response = await fetch(
        'https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/items/' + orderId,
        r
      )
  ...
  async function handleChangeDelivered(event: any) {
    try {
      ...
      await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/delivered', r)
      loadOrders()
    } catch (error) {
      Router.replace('/pages/misc/500-server-error')
    }
  ...
  async function handleChangePaided(event: any) {
    try {
      ...
      await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/paided', r)
  ...
  async function handleRemoveOrder(event: any) {
    try {
      ...
      if (!(id == '' || id == undefined)) {
        ...
        await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order', r)
        loadOrders()
      }
    } catch (error) {
      Router.replace('/pages/misc/500-server-error')
  ...
  async function handleRemoveItemOfOrder0(event: any) {
    ...
    try {
      ...
      await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/item/' + tempId + '/' + id, r)

      const r1 = {
        method: 'GET'
      }
      const response = await fetch(
        'https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/items/' + tempId,
        r1
      )
  ...
  async function handleChangeQuantity(event: any) {
    ...
    try {
      if (event.target.value > 0) {
        ...
        await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/item/update-quantity', r)
      }
  ...
  async function handleChangeNote() {
    ...
    try {
      ...
      await fetch('https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/note', r)
      loadOrders()
    } catch (error) {
      alert(error)
      Router.replace('/pages/misc/500-server-error')
  ...
  async function handleStatistical() {
    try {
      ...
      const response = await fetch(
        'https://at6923hja1.execute-api.ap-southeast-1.amazonaws.com/order/statistical/' + date1 + '/' + date2,
        r
      )
