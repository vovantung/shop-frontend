...
const Orders = () => {
  ...
  async function getViewItemsOrder(orderId: string) {
    try {
      ...
      const response = await fetch(
        'https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/items/' + orderId,
        r
      )
  ...
  async function handleChangeDelivered(event: any) {
    try {
      ...
      await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/delivered', r)
      loadOrders()
    } catch (error) {
      Router.replace('/pages/misc/500-server-error')
    }
  ...
  async function handleChangePaided(event: any) {
    try {
      ...
      await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/paided', r)
  ...
  async function handleRemoveOrder(event: any) {
    try {
      ...
      if (!(id == '' || id == undefined)) {
        ...
        await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order', r)
        loadOrders()
      }
    } catch (error) {
      Router.replace('/pages/misc/500-server-error')
  ...
  async function handleRemoveItemOfOrder0(event: any) {
    ...
    try {
      ...
      await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/item/' + tempId + '/' + id, r)

      const r1 = {
        method: 'GET'
      }
      const response = await fetch(
        'https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/items/' + tempId,
        r1
      )
  ...
  async function handleChangeQuantity(event: any) {
    ...
    try {
      if (event.target.value > 0) {
        ...
        await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/item/update-quantity', r)
      }
  ...
  async function handleChangeNote() {
    ...
    try {
      ...
      await fetch('https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/note', r)
      loadOrders()
    } catch (error) {
      alert(error)
      Router.replace('/pages/misc/500-server-error')
  ...
  async function handleStatistical() {
    try {
      ...
      const response = await fetch(
        'https://alb-app1-227838523.ap-southeast-1.elb.amazonaws.com:8080/order/statistical/' + date1 + '/' + date2,
        r
      )
